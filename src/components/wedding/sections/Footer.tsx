...
export default function Footer() {
  return (
    <footer className="relative bg-[#2D0A11] px-6 pt-4 pb-32 md:py-24 text-center text-cream overflow-hidden">
      {/* Subtle radial glow */}
      ...
      <div className="relative z-10 mx-auto max-w-3xl flex flex-col items-center">
        ...
        <div className="flex flex-col items-center justify-center mb-2 md:mb-10">
          <Om className="h-10 w-10 text-gold" />
        </div>
        ...
        <div className="mt-8 md:mt-16 flex flex-col items-center gap-2 md:gap-6">
